...
export class CreateTableOrderAndOrderProduct1698654161005 implements MigrationInterface {
    name = 'CreateTableOrderAndOrderProduct1698654161005'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`description\` varchar(255) NULL, \`orderNo\` varchar(255) NOT NULL, \`regDt\` varchar(255) NOT NULL, \`modDt\` varchar(255) NULL, \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
